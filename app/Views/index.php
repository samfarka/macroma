            ...
            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
              <blockquote>
                <div>
                  ...
                  <p class="mt-6 text-2xl font-medium text-white">Stigma buruk orang tua tentang game sudah ada sejak dulu. Namun seiring berkembangnya teknologi dan era yang semakin maju. Game tidak hanya bisa digunakan untuk bersenang - senang namun sekarang game bisa dimanfaatkan sebagai media belajar juga.</p>
                </div>
                <footer class="mt-6">
